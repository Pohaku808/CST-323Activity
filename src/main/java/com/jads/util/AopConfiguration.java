...
public class AopConfiguration
{
	...
	@Pointcut("execution(* com.jads..controller..*(..)) || execution(* com.jads..business..*(..)) || execution(* com.jads..data..*(..))")
	public void monitor()
	{
	}
	...
	public Advisor performanceMonitorAdvisor()
	{
		...
		pointcut.setExpression("com.jads.util.AopConfiguration.monitor()");
