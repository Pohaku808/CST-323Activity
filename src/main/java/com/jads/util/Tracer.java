...
public class Tracer extends AbstractMonitoringInterceptor
{
    ...
    protected Object invokeUnderTrace(MethodInvocation invocation, Log log) throws Throwable 
    {
        ...
        finally 
        {
            ...
            long time = end - start;
            log.trace("JADS Method " + name + " execution lasted:" + time + " ms");
            log.trace("JADS Method " + name + " execution ended at:" + new Date());            
            if (time > 10)
                log.warn("JADS Method execution longer than 10 ms!");
        }
    }
}
